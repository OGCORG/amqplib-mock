...
export class Channel implements AmqplibChannel {
  ...
  // @ts-ignore
  assertExchange (exchange: string, type: "direct" | "topic" | "headers" | "fanout" | "match" | string, options?: Options.AssertExchange): Bluebird<Replies.AssertExchange> {
  ...
  // @ts-ignore
  consume (queue: string, onMessage: (msg: (ConsumeMessage | null)) => void, options?: Options.Consume): Bluebird<Replies.Consume> {
